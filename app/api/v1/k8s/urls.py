...
urlpatterns = [
    ...
    path('single-ru-restart', views.RestartSingleDU, name='single-ru-restart'),
    ...
    path('multignb-ru1-restart', views.RestartMultignbDU1, name='multignb-ru1-restart'),
    path('multignb-ru2-restart', views.RestartMultignbDU2, name='multignb-ru2-restart'),
